        ...
        <div class="row">
            <div class="col">
                ...
                <form class="update-form p-4 mb-4" wire:submit.prevent='updateEmail'>
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">{{ $supervisor->email }}</label>
                ...
                <form class="update-form p-4 mb-4" wire:submit.prevent='updateAddress'>
                    ...
                    <div class="mb-3">
                        <label for="address" class="form-label">{{ $supervisor->address }}</label>
                ...
                <form class="update-form p-4 mb-4" wire:submit.prevent='updatePhone'>
                    ...
                    <div class="mb-3">
                        <label for="phone" class="form-label">{{ $supervisor->phone }}</label>
                ...
                <form class="update-form p-4 mb-4" wire:submit.prevent='updateBirthdate'>
                    ...
                    <div class="mb-3">
                        <label for="birthdate" class="form-label">{{ $supervisor->birthdate }}</label>
                ...
                <form class="update-form p-4 mb-4" wire:submit.prevent='updateStatus'>
                    ...
                    <div class="mb-3">
                        <label for="status" class="form-label">{{ $supervisor->status }}</label>
